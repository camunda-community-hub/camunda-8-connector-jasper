...
public class ElementTemplateGenerator {
    ...
    public static void generate() {
        ...
        try {
            RunnerDecorationTemplate runnerDecorationTemplate = new RunnerDecorationTemplate(new JasperFunction());
            runnerDecorationTemplate.generateElementTemplate("./element-templates/", "jasper-function.json");
        } catch (Exception e) {
