...
@OutboundConnector(name = "JasperFunction", inputVariables = {
        ...
        JasperInput.INCLUDE_PROCESS_HISTORY}, type = "c-jasper-function")
 ...
 */
    ...
    public JasperOutput execute(OutboundConnectorContext outboundConnectorContext) throws Exception {
        ...
        ByteArrayOutputStream jasperReport = jasperGeneration.generate(format,
                ...
                jasperInput.getData(),
                getContextVariable("context", outboundConnectorContext),
                historyData);
    ...
    private Map<String, Object> getContextVariable(String name, OutboundConnectorContext outboundConnectorContext) {
