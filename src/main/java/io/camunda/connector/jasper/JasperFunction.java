...
@OutboundConnector(name = "JasperFunction", inputVariables = {
        ...
        JasperInput.FORMATEXPORT,
        JasperInput.PARAMETERS,
        JasperInput.DESTINATION_FILE_NAME,
        JasperInput.DESTINATION_JSONSTORAGEDEFINITION,
        JasperInput.INCLUDEPROCESSHISTORY}, type = "c-jasper-function")
...
public class JasperFunction implements OutboundConnectorFunction, CherryConnector {
    ...
    public JasperOutput execute(OutboundConnectorContext outboundConnectorContext) throws Exception {
        ...
        ByteArrayOutputStream jasperReport = jasperGeneration.generate(format,
                ...
                jasperInput.getParameters(),
                contextVariable("context", outboundConnectorContext),
                new HashMap<>());
        ...
        try {
            ...
            jasperOutput.destinationFileJson = outputFileReference.toJson();
            ...
            throw new ConnectorException(JasperError.ERROR_CREATE_FILEVARIABLE,
    ...
    private Map<String, Object> contextVariable(String name, OutboundConnectorContext outboundConnectorContext) {
        return Map.of("processInstanceKey", outboundConnectorContext.getJobContext().getProcessInstanceKey(),
                "tenantId", outboundConnectorContext.getJobContext().getTenantId(),
                "processDefinitionKey", outboundConnectorContext.getJobContext().getProcessDefinitionKey(),
                "processDefinitionVersion", outboundConnectorContext.getJobContext().getProcessDefinitionVersion());
    }
    ...
    public Map<String, String> getListBpmnErrors() {
        ...
        allErrors.put(JasperError.ERROR_BAD_INPUTPARAMETER, JasperError.ERROR_BAD_INPUTPARAMETER_EXPLANATION);
        allErrors.put(JasperError.ERROR_LOAD_DOCSOURCE, JasperError.ERROR_LOAD_DOCSOURCE_LABEL);
